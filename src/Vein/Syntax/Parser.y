...
params_props :: {(Located [Located (Param LocatedExpr)] , Located (ParsedEnv Module.QN LocatedExpr))} :
...
prop :: {Located (Either (ParseError Module.QN LocatedExpr) (Prop Module.QN LocatedExpr))} :
...
props :: {Located [Located (Either (ParseError Module.QN LocatedExpr) (Prop Module.QN LocatedExpr))]} :
